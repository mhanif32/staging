...
class ControllerAccountFb extends Controller {
    ...
    public function index() {
        ...
        $this->load->language('account/social');
        ...
        if($fbUserProfile){
            ...
            $oauth_uid = $this->model_account_social_login->oauthId($fbUserProfile['id']);
            ...
            $userData = $this->model_account_social_login->checkUser($fbUserData);
        ...
        if(isset($userData['email'])){
            ...
            if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
                ...
                $this->model_account_social_login->updatecustomer($email,$password,$userData);
        ...
        $data['action'] = $this->url->link('account/fb', '', true);
        ...
        $this->response->setOutput($this->load->view('account/fb', $data));
    }
