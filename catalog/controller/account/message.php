...
class ControllerAccountMessage extends Controller {
    public function index() {
        ...
        $total_chats = $this->model_account_message->getTotalSellerMessageChats($filter_data);

        $chats = $this->model_account_message->getSellerMessageChats($filter_data);
        ...
        $this->model_account_message->MarkAsReadMessage($mpseller_id);
