<?php
class ModelExecutivememberSubscription extends Model {
    public function getSubscriptionPlan($plan_id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "subscription_plan_em WHERE plan_id = '" . (int)$plan_id . "'");
        return $query->row;
    }

    public function getSubscriptionPlans($sessionCurrency = NULL)
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "subscription_plan_em WHERE name != 'Free'";
    ...
    {
        $this->db->query("INSERT INTO " . DB_PREFIX . "subscription_user_stripe_card_em SET 
    ...
    {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "subscription_user_stripe_card_em WHERE customer_id = '" . (int)$customer_id . "'");
    ...
    {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "subscription_user_stripe_card_em WHERE customer_id = '" . (int)$customer_id . "' and user_stripe_card_id = '". (int)$user_card_id ."'");
    ...
    {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "subscription_user_plan_em WHERE customer_id = '" . (int)$customer_id . "'");
    ...
    public function removeUserSubscription($subscription_plan_id)
    {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "subscription_user_plan_em SET stripe_status = 'cancelled' WHERE customer_id = '" . (int)$this->customer->getId() . "' AND subscription_plan_id = '".$subscription_plan_id."'");
