  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-message').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input type="text" name="filter_fname" value="<?php echo $filter_fname; ?>" placeholder="<?php echo $entry_store_owner; ?>" id="input-store-owner" class="form-control" />
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-lname"><?php echo $entry_store_name; ?></label>
                <input type="text" name="filter_lname" value="<?php echo $filter_lname; ?>" placeholder="<?php echo $entry_store_name; ?>" id="input-lname" class="form-control" />
              </div>
