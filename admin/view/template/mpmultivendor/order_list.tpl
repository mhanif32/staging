...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" id="button-shipping" form="form-order" formaction="<?php echo $shipping; ?>"
                        formtarget="_blank" data-toggle="tooltip" title="<?php echo $button_shipping_print; ?>"
                        class="btn btn-info"><i class="fa fa-truck"></i></button>
                <button type="submit" id="button-invoice" form="form-order" formaction="<?php echo $invoice; ?>"
                        formtarget="_blank" data-toggle="tooltip" title="<?php echo $button_invoice_print; ?>"
                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-mpseller-order-status"><?php echo $entry_mpseller_order_status; ?></label>
                                <select name="filter_mpseller_order_status" id="input-mpseller-order-status"
                                        class="form-control">
                                    <option value="*"></option>
                                    <?php if ($filter_mpseller_order_status == '0') { ?>
                                    <option value="0" selected="selected"><?php echo $text_missing; ?></option>
                                    <?php } else { ?>
                                    <option value="0"><?php echo $text_missing; ?></option>
                                    <?php } ?>
                                    <?php foreach ($order_statuses as $order_status) { ?>
                                    <?php if ($order_status['order_status_id'] == $filter_mpseller_order_status) { ?>
                                    <option value="<?php echo $order_status['order_status_id']; ?>"
                                            selected="selected"><?php echo $order_status['name']; ?></option>
                                    <?php } else { ?>
                                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'customer') { ?>
                                    ...
                                    <?php } ?></td>
                                <td class="text-center"><?php echo $column_store_information; ?></td>
                            ...
                            <tr>
                                        ...
                                        <tr>
                                           <!--<td>
                                            ...
                                            <td style="border-top: none;">
                                                ...
                                                <a data-link="<?php echo $seller_product['view']; ?>"
                                                   data-seller="<?php echo $seller_product['mpseller_id']; ?>"
                                                   data-order="<?php echo $seller_product['order_id']; ?>"
                                                   data-toggle="tooltip" title="<?php echo $button_view; ?>"
                                                   class="btn btn-info btn-sm button-info button-info<?php echo $seller_product['order_id']; ?>-<?php echo $seller_product['mpseller_id']; ?>"><i
                                                            class="fa fa-info-circle"></i></a></button>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip"
                                                          title="<?php echo $button_view; ?>" class="btn btn-info"><i
    ...
    <script type="text/javascript"><!--
        $('#button-filter').on('click', function () {
            url = 'index.php?route=mpmultivendor/order&user_token=<?php echo $user_token; ?>';
            ...
            var filter_mpseller_order_status = $('select[name=\'filter_mpseller_order_status\']').val();

            if (filter_mpseller_order_status != '*') {
                url += '&filter_mpseller_order_status=' + encodeURIComponent(filter_mpseller_order_status);
            }
    ...
    <script type="text/javascript"><!--
        $('.button-info').on('click', function () {
            ...
            var mpseller_id = $(this).attr('data-seller');
            var link_url = $(this).attr('data-link');
            $.ajax({
                url: link_url,
                dataType: 'html',
                beforeSend: function () {
                    $('.button-info' + order_id + '-' + mpseller_id).button('loading');
                },
                complete: function () {
                    $('.button-info' + order_id + '-' + mpseller_id).button('reset');
                },
                success: function (html) {
                    $('body').append(html);

                    $('#Mpseller-modal').modal('show');
                }
            });
        });
        //--></script>
