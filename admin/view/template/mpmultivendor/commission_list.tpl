    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                if(!empty($dataUSD)) {
                ?>
                <h5 class="text-right">Total Admin Fee (in USD): <b><?php echo $dataUSD;?></b>
                <?php } ?>
                <?php
                if(!empty($dataNGN)) {
                ?>
                <h5 class="text-right">Total Admin Fee (in NGN): <b><?php echo $dataNGN;?></b>
                <?php } ?>
                <?php
                if(!empty($dataEUR)) {
                ?>
                <h5 class="text-right">Total Admin Fee (in EUR): <b><?php echo $dataEUR;?></b>
                <?php } ?>
                <?php
                if(!empty($dataGBP)) {
                ?>
                <h5 class="text-right">Total Admin Fee (in GBP): <b><?php echo $dataGBP;?></b>
                <?php } ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php if ($sort == 'name') { ?>
                                    <a href="<?php echo $sort_name; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_product_name; ?></a>
                                    <?php } else { ?>
