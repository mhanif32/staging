                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="filter_store_owner" value="<?php echo $filter_store_owner; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="filter_store_name" value="<?php echo $filter_store_name; ?>"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'c.email') { ?>
                                    ...
                                    <?php } ?></td>
                                <td class="text-left">Membership</td>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($mpseller['mpseller_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $mpseller['mpseller_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $mpseller['mpseller_id']; ?>"/>
                                    <?php } ?></td>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo $mpseller['message_link']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_message; ?>" class="btn btn-primary"><i
                                                class="fa fa-paper-plane"></i></a>

                                    <?php if ($mpseller['approve']) { ?>
                                    <a href="<?php echo $mpseller['approve']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_approve; ?>" class="btn btn-success"><i
                                    ...
                                    <div class="btn-group" data-toggle="tooltip" title="<?php echo $button_login; ?>">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a href="index.php?route=customer/customer/login&user_token=<?php echo $user_token; ?>&customer_id=<?php echo $mpseller['customer_id']; ?>&store_id=0"
                                                   target="_blank"><?php echo $text_default; ?></a></li>
                                            <?php foreach ($stores as $store) { ?>
                                            <li>
                                                <a href="index.php?route=customer/customer/login&user_token=<?php echo $user_token; ?>&customer_id=<?php echo $mpseller['customer_id']; ?>&store_id=<?php echo $store['store_id']; ?>"
                                                   target="_blank"><?php echo $store['name']; ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>

                                    <a href="<?php echo $mpseller['edit']; ?>" data-toggle="tooltip"
