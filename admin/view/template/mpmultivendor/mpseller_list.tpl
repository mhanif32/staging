            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="<?php echo $mpseller['message_link']; ?>" data-toggle="tooltip" title="<?php echo $button_message; ?>" class="btn btn-primary"><i class="fa fa-paper-plane"></i></a>
                    ...
                    <a href="<?php echo $mpseller['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
