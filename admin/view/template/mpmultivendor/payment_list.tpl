  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <h3 class="text-right"><?php echo $text_final_paid; ?>: <b><?php echo $final_payment; ?></b></h3>
        <br>
        <div id="form-payment">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-left"><?php echo $transaction['store_owner']; ?></td>
                  <td class="text-left"><?php echo $transaction['store_name']; ?></td>
...
$('#button-filter').on('click', function() {
  var url = 'index.php?route=mpmultivendor/payment&user_token=<?php echo $user_token; ?>';
