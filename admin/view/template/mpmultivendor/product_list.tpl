            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'p.store_owner') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><a href="<?php echo $product['editseller']; ?>"><?php echo $product['store_owner']; ?></a></td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=mpmultivendor/product&user_token=<?php echo $user_token; ?>';
...
$('input[name=\'filter_model\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=mpmultivendor/product/autocomplete&user_token=<?php echo $user_token; ?>&filter_model=' +  encodeURIComponent(request),
      dataType: 'json',
      success: function(json) {
        response($.map(json, function(item) {
          return {
