  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-mpseller" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
        ...
        <div class="row">
          ...
          <div class="col-sm-2">
            <div class="seller-links text-left">
              <a href="<?php echo $seller_products; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-tag"></i> <?php echo $button_products; ?></a>
              <a href="<?php echo $seller_enquiries; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-question-circle"></i> <?php echo $button_enquiries; ?></a>
              <a href="<?php echo $seller_reviews; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-star"></i> <?php echo $button_reviews; ?></a>
              <a href="<?php echo $seller_orders; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-shopping-cart"></i> <?php echo $button_orders; ?></a>
              <a href="<?php echo $seller_commission; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-money"></i> <?php echo $button_commission; ?></a>
              <a href="<?php echo $seller_transaction; ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-dollar"></i> <?php echo $button_transaction; ?></a>
            </div>
          </div>  
          <?php } ?>
          <div class="col-sm-10 right-part">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mpseller" class="form-horizontal">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-general">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="meta_description" id="input-storemeta" rows="5" class="form-control"><?php echo $meta_description; ?></textarea>
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="meta_keyword" rows="5" class="form-control"><?php echo $meta_keyword; ?></textarea>
                        ...
                        <tr>
                          ...
                          <td class="text-left"><?php foreach($languages as $language) { ?>
                            <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                              <input type="text" name="seller_seo_url[<?php echo $store['store_id']; ?>][<?php echo $language['language_id']; ?>]" value="<?php echo isset($seller_seo_url[$store['store_id']][$language['language_id']]) ? $seller_seo_url[$store['store_id']][$language['language_id']] : ''; ?>" placeholder="<?php echo $entry_seo_keyword; ?>" class="form-control" />
                            </div>
                    ...
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-left"><?php foreach($languages as $language) { ?>
                            <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                              <input type="text" name="review_seo_url[<?php echo $store['store_id']; ?>][<?php echo $language['language_id']; ?>]" value="<?php echo isset($review_seo_url[$store['store_id']][$language['language_id']]) ? $review_seo_url[$store['store_id']][$language['language_id']] : ''; ?>" placeholder="<?php echo $entry_review_seo_keyword; ?>" class="form-control" />
                            </div>
                ...
                <div class="tab-pane" id="tab-store">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-store-owner"><?php echo $entry_store_owner; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="store_owner" value="<?php echo $store_owner; ?>" placeholder="<?php echo $entry_store_owner; ?>" id="input-store-owner" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="address" class="form-control" placeholder="<?php echo $entry_address; ?>"><?php echo $address; ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="facebook_url" placeholder="<?php echo $entry_facebook; ?>" value="<?php echo $facebook_url; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_google_plus; ?>" value="<?php echo $google_plus_url; ?>" name="google_plus_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_twitter; ?>" value="<?php echo $twitter_url; ?>" name="twitter_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_pinterest; ?>" value="<?php echo $pinterest_url; ?>" name="pinterest_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_linkedin; ?>" value="<?php echo $linkedin_url; ?>" name="linkedin_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_youtube; ?>" value="<?php echo $youtube_url; ?>" name="youtube_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $entry_instagram; ?>" value="<?php echo $instagram_url; ?>" name="instagram_url">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-flickr" aria-hidden="true"></i></span>
                        <input type="text" class="form-control" placeholder="<?php echo $entry_flickr; ?>" value="<?php echo $flickr_url; ?>" name="flickr_url">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="tab-shipping">
                    ...
                    <div class="col-sm-4">
                      <div class="btn-group btn-group-justified" data-toggle="buttons">
                        <label class="shipping_type btn btn-primary <?php echo $shipping_type == 'order_wise' ? 'active' : '';  ?>">
                          <input type="radio" name="shipping_type" value="order_wise" <?php echo $shipping_type == 'order_wise' ? 'checked="checked"' : ''; ?> /><?php echo $text_order_wise; ?>
                        </label>
                        <label class="shipping_type btn btn-primary <?php echo $shipping_type == 'product_wise' ? 'active' : '';  ?>">                            
                          <input type="radio" name="shipping_type" value="product_wise" <?php echo $shipping_type == 'product_wise' ? 'checked="checked"' : ''; ?> /><?php echo $text_product_wise; ?>
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="shipping_amount" value="<?php echo $shipping_amount; ?>" placeholder="<?php echo $entry_shipping_amount; ?>" />
                ...
                <div class="tab-pane" id="tab-payment">
                    ...
                    <div class="col-sm-6">
                      <div class="btn-group btn-group-justified" data-toggle="buttons">
                        <label class="payment_type btn btn-primary <?php echo $payment_type == 'paypal' ? 'active' : '';  ?>">
                          <input type="radio" name="payment_type" value="paypal" <?php echo $payment_type == 'paypal' ? 'checked="checked"' : ''; ?> /><?php echo $text_paypal; ?>
                        </label>
                        <label class="payment_type btn btn-primary <?php echo $payment_type == 'bank' ? 'active' : '';  ?>">                            
                          <input type="radio" name="payment_type" value="bank" <?php echo $payment_type == 'bank' ? 'checked="checked"' : ''; ?> /><?php echo $text_bank_transfer; ?>
                        </label>
                        <label class="payment_type btn btn-primary <?php echo $payment_type == 'cheque' ? 'active' : '';  ?>">                            
                          <input type="radio" name="payment_type" value="cheque" <?php echo $payment_type == 'cheque' ? 'checked="checked"' : ''; ?> /><?php echo $text_cheque; ?>
                        </label>
                      </div>                      
                  ...
                  <div class="form-group required payment_paypal <?php echo $payment_type == 'paypal' ? '' : 'hide'; ?>">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="paypal_email" value="<?php echo $paypal_email; ?>" placeholder="<?php echo $entry_paypal_email; ?>" />
                  ...
                  <div class="form-group required payment_bank <?php echo $payment_type == 'bank' ? '' : 'hide'; ?>">
                    ...
                    <div class="col-sm-10">
                      <textarea name="bank_details" rows="8" class="form-control" placeholder="<?php echo $entry_bank_details; ?>"><?php echo $bank_details; ?></textarea>
                  ...
                  <div class="form-group required payment_cheque <?php echo $payment_type == 'cheque' ? '' : 'hide'; ?>">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="cheque_payee_name" value="<?php echo $cheque_payee_name; ?>" placeholder="<?php echo $entry_cheque_payee; ?>" />
                ...
                <div class="tab-pane" id="tab-commission">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-4 col-md-2">
                      <div class="input-group">
                        <input type="text" class="form-control" name="commission_rate" value="<?php echo $commission_rate; ?>" placeholder="<?php echo $entry_commission_rate; ?>" />
