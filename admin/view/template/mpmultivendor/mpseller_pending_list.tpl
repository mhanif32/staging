                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-mpseller">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($mpseller['customer_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $mpseller['customer_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $mpseller['customer_id']; ?>"/>
                                    <?php } ?></td>
                                <td class="text-left"><?php echo $mpseller['firstname']; ?></td>
                                <td class="text-left"><?php echo $mpseller['lastname']; ?></td>
                                ...
                                <td class="text-right">
                                    <a href="javascript:void(0)" data-toggle="tooltip"
                                       title="Send Remind Mail To Seller" class="btn btn-primary send-remind"
                                       data-id="<?php echo $mpseller['customer_id']; ?>"><i
