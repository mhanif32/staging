<?php
class ControllerMpmultivendorMpsellerMessage extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('mpmultivendor/mpseller_message/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$message_total = $this->model_mpmultivendor_mpseller_message->getTotalSellerMessages($filter_data);

		$results = $this->model_mpmultivendor_mpseller_message->getSellerMessages($filter_data);

		foreach ($results as $result) {
			// Total unread Messages
			$total_unreads = $this->model_mpmultivendor_mpseller_message->getTotalUnreadMessages($result['mpseller_id']);
			...
			$data['seller_messages'][] = array(
				...
				'edit'           => $this->url->link('mpmultivendor/mpseller_message/view', 'user_token=' . $this->session->data['user_token'] . '&mpseller_id=' . $result['mpseller_id'] . $url, true)
			);
		}
		...
		$this->response->setOutput($this->load->view('mpmultivendor/mpseller_message_list', $data));
	}
