...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'cookie-consent';
        $this->app_name = 'Cookie Consent';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/cookie-consent-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightCookieConsent extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/cookie-consent/?utm_source=portals&utm_medium=opencart&utm_campaign=cookie-consent&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_cookie_consent');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_cookie_consent', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_cookie_consent', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_cookie_consent_status'])) {
            $data['module_cookie_consent_status'] = $this->request->post['module_cookie_consent_status'];
        } else {
            $data['module_cookie_consent_status'] = $this->config->get('module_cookie_consent_status');
        }

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');

        $this->response->setOutput($this->load->view('extension/module/elfsight_cookie_consent', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_cookie_consent')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/cookie-consent-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/cookie-consent-assets/popup.php';
    }
