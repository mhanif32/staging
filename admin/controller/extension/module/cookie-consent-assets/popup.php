<link rel="stylesheet" href="./controller/extension/module/cookie-consent-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="cookie-consent-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Cookie Consent</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/cookie-consent-assets/popup.js';
