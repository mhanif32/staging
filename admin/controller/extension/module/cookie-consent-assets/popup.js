(function($) {
    ...
    let $deactivateForm  = jQuery('#cookie-consent-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('cookie-consent-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'cookie-consent-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('cookie-consent-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_cookie_consent.php', jQuery.param(data)).then(function(result) {
