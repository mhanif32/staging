...
class ControllerExtensionModuleSocialLogin extends Controller {
    ...
    public function index() {
        ...
        $this->load->model('catalog/social_login');

        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_catalog_social_login->addSocialLogins();
        ...
        $data['module_social_login_facebook_callback'] = HTTPS_CATALOG . 'index.php?route=account/fb';
        ...
        $data['module_social_login_google_callback'] = HTTPS_CATALOG . 'index.php?route=account/google';
