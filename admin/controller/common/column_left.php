...
class ControllerCommonColumnLeft extends Controller
{
    public function index()
    {
        if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            $customer[] = array(
                'name' => 'Delivery Partners Payments',
                'href' => $this->url->link('deliverypartner/payments', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            ...
            if ($this->user->hasPermission('access', 'localisation/area')) {
                $localisation[] = array(
                    'name' => $this->language->get('text_area'),
                    'href' => $this->url->link('localisation/area', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
