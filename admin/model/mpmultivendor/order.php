<?php
class ModelMpmultivendorOrder extends Model {
	...
	public function getOrders($data = array()) {
		...
		if (isset($data['filter_mpseller_order_status'])) {
			$implode = array();

			$order_statuses = explode(',', $data['filter_mpseller_order_status']);

			foreach ($order_statuses as $order_status_id) {
				$implode[] = "mpo.order_status_id = '" . (int)$order_status_id . "'";
			}
	...
	public function getSellerOrderTotals($order_id, $mpseller_id) {
